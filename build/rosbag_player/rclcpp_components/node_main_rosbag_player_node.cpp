...
#define NODE_MAIN_LOGGER_NAME "rosbag_player_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librosbag_player.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<RosbagPlayer>";
